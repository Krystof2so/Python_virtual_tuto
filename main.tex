...
\usepackage{enumitem}  % Personnaliser l'apperence des listes
...
\lstdefinestyle{bash}{
    ...
    keywords={
        ...
        ls, mkdir, pip, pipx, poetry, 
        pyenv, python, python3, rm, sh,
        source, tree, uv, venv, virtualenv,
        which
    },
}
...
\lstdefinestyle{repl}{
    ...
    morekeywords={executable, prefix, requests, sys, sysconfig}
}
...
% ------------------------------------------
% --- STYLE PERSONNALISE POUR LES LISTES ---
% ------------------------------------------
% Environnement 'enumerate' avec des numéros en vert :
\newlist{coloredenum}{enumerate}{1}
\setlist[coloredenum]{
    label={\textcolor{nord14}{\arabic* --}},
    ref=\arabic*
}

% Définir un nouvel environnement basé sur description
\newenvironment{optionlist}
  {\begin{list}{}{\setlength{\labelwidth}{0pt}%
    ...
    \setlength{\partopsep}{0pt}%
      \renewcommand{\makelabel}[1]{\fontfamily{zi4}\selectfont\texttt{##1}\hfil}%
  }}
  {\end{list}}
...
\include{annexes/go_further.tex}
\include{annexes/pyenv_poetry.tex}
